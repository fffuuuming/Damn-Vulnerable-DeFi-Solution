...
contract WalletMiningChallenge is Test {
    ...
    function test_walletMining() public checkSolvedByPlayer {
        console.log("User can: ", walletDeployer.can(user, USER_DEPOSIT_ADDRESS));
        console.log("authorizer address: ", address(authorizer));   
        // console.log("Actual Implementation address: ", authorizer.implementation());
        console.log("User's deposit address: ", USER_DEPOSIT_ADDRESS);
    }
